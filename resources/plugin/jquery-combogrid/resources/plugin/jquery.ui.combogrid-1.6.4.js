...
(function($, undefined) {
    ...
    $.widget("cg.combogrid", {
        ...
        _create: function() {
            ...
            if (self.options.sButton) {
                this.element.after('<a class="input-group-addon ' + self.element.attr('id') + ' cg-searchButton"><i class="fa fa-search"></i></a>');
        ...
        _renderHeader: function(ul, colModel) {
            ...
            $.each(colModel, function(index, col) {
				...
				if (col.columnAlign == undefined) { col.columnAlign = "center"; }
                var hide = "";
                ...
                if (col.columnName == self.cssCol) {
                    div.append('<div class="cg-colHeader" style="width:' + col.width + self.options.munit + ';' + hide + ' text-align:' + col.columnAlign + '"><label class="cg-colHeader-label" id="' + col.columnName + '">' +
